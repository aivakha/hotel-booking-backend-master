            ...
            <div class="card-header">
                <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                        <h5 class="mb-0">{{ __('Редагувати роль') }}</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-pane preview-tab-pane active" role="tabpanel">
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="title" value="{{ $role->name }}" name="name" type="text">
                            </div>

                            <div class="mb-3">
                                @foreach($permissions as $permission)
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value="{{ $permission->id }}" name="permissions[]" @if ($role->hasPermissionTo($permission->name)) checked @endif>
