        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    <div class="col-md">
                        <h5 class="mb-2 mb-md-0">{{ __('Налаштування регіонів') }}</h5>
                    </div>
                    <div class="col-auto">
                        <a href="{{route('cities.create')}}" class="btn btn-success me-1 mb-1">{{ __('Додати') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-header">
                <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                        <h5 class="mb-0">{{ __('Всі регіони') }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                @if ($cities->isNotEmpty())
                    <div id="tableExample2" data-list='{"valueNames":["id", "title"],"page":20,"pagination":true}'>
                                ...
                                <tbody class="list" style="vertical-align: middle">
                                    @foreach($cities as $city)
                                        <tr>
                                            ...
                                            <td class="title">{{ $city->title }}</td>
                                            <td class="actions">
                                                <div class="actions-btn">
                                                    <a class="btn p-0" href="{{route('cities.edit', $city->id)}}">
